      ...
      <div class="order-header">
        <div class="order-header-left-section">
          ...
          <div class="order-total">
            ...
            <div>&#8377 ${fromatCurrency(order.totalCostCents)}</div>
          </div>
        </div>
        ...
        <div class="order-details-grid js-orders-grid">
    ...
    productListHTML += `
      ...
      <div class="product-details">
        ...
        <div class="product-delivery-date">
          Arriving on: ${dayjs(orderDetails.estimatedDeliveryTime).format('MMMM DD')}
        </div>
